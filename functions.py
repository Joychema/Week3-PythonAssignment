...
# after applying a discount. The function should take the original price (price) and the 
# discount percentage (discount_percent) as parameters. If the discount is 20% or higher, 
